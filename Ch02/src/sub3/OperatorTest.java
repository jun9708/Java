...
public class OperatorTest {
	public static void main(String[] args) {
		...
		boolean res1 = (var3 > 3) && (var4 > 3); // var3가 3보다 크고 (false) 그리고 var4가 3보다 크다 (true) (false)
		boolean res2 = (var3 > 2) && (var4 > 3); // var3가 2보다 크고(true) 그리고 var4가 3보다 크다 (true) (true)
		boolean res3 = (var3 > 3) || (var4 > 3); // var3가 3보다 크거나 var4가 3보다 크다 (true)
		boolean res4 = (var3 > 3) || (var4 > 5); // var3가 3보다 크거나 var4가 5보다 크다 (false)
		boolean res5 = !(var3 > var4); // var3은 var4보다 크지않다 (true)
